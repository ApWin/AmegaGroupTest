...
import MarketDataIcon from 'assets/media/icons/MarketDataIcon';
import MainTabIcon from 'assets/media/icons/MainTabIcon';
import ProfileTabIcon from 'assets/media/icons/ProfileTabIcon';
